...
if($focus->mode != 'edit' && $mod_seq_field != null) {
	...
	$mod_seq_string = $adb->pquery("SELECT prefix, current from vtiger_autonumberprefix where semodule = ? and active=1",array($currentModule));
	$mod_seq_prefix = $adb->query_result($mod_seq_string,0,'prefix');
	$mod_seq_no = $adb->query_result($mod_seq_string,0,'current');
