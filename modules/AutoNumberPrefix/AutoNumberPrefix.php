...
class AutoNumberPrefix extends CRMEntity {
	...
	var $table_name = 'vtiger_autonumberprefix';
	var $table_index= 'autonumberprefixid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_autonumberprefix', 'autonumberprefixid');
	// Uncomment the line below to support custom field columns on related lists
	// var $related_tables = Array('vtiger_autonumberprefix'=>array('autonumberprefixid','vtiger_autonumberprefix', 'autonumberprefixid'));

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_autonumberprefix', 'vtiger_autonumberprefixcf');
	...
	var $popup_fields = Array('prefix');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'prefix';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'prefix';

	// Required Information for enabling Import feature
	var $required_fields = Array('prefix'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'prefix';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'prefix');
